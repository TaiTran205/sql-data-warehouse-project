/*
===============================================================================
Thủ tục: Nạp dữ liệu tầng Silver (Bronze -> Silver Layer)
===============================================================================
Mục đích:
    Lấy dữ liệu từ tầng Bronze, thực hiện làm sạch và chuẩn hóa rồi nạp vào Silver.
===============================================================================
*/
...
BEGIN
    ...
    END TRY
    BEGIN CATCH
        -- Khối xử lý khi có lỗi xảy ra
        SELECT 
            ' CO LOI XAY RA KHI NAP TANG SILVER' AS ErrorStatus,
